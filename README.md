...
| 8   | GET    | `/api/v1/users/{id}/subscription` | Faisal |
| 9   | DELETE | `/api/v1/users/{id}/card` | Faisal |
| 10  | GET    | `/api/v1/cars/get` | Faisal |
| 11  | POST   | `/api/v1/cars/add` | Faisal |
| 12  | PUT    | `/api/v1/cars/update/{id}` | Faisal |
| 13  | PUT    | `/api/v1/cars/update/{carId}/mileage` | Faisal |
| 14  | DELETE | `/api/v1/cars/delete/{id}` | Faisal |
| 15  | GET    | `/api/v1/cars/get/user` | Faisal |
...
| 22  | GET    | `/api/v1/cars/maintenance-cost/{make}/{model}/yearly` | Faisal |
| 23  | GET    | `/api/v1/cars/visit-frequency/{make}/{model}` | Faisal |
| 24  | GET    | `/api/v1/cars/typical-mileage/{make}/{model}` | Faisal |
| 25  | GET    | `/api/v1/cars/numbers/{userId}` | Faisal |
| 26  | PUT    | `/api/v1/cars/{userId}/enforce-access` | Faisal |
...
| 31  | GET    | `/api/v1/maintenances/get/{carId}` | Faisal |
...
| 41  | POST   | `/api/v1/payments/card` | Faisal |
...
| 45  | GET    | `/api/v1/payments/status/{paymentId}` | Faisal |
| 46  | GET    | `/api/v1/payments/payment/{paymentId}` | Faisal |
...
| 56  | POST   | `/api/v1/transfer-requests/{id}/accept` | Faisal |
| 57  | POST   | `/api/v1/transfer-requests/{id}/reject` | Faisal |
| 58  | POST   | `/api/v1/transfer-requests/{id}/cancel` | Faisal |
| 59  | GET    | `/api/v1/transfer-requests/{id}` | Faisal |
| 60  | GET    | `/api/v1/transfer-requests/incoming` | Faisal |
| 61  | GET    | `/api/v1/transfer-requests/outgoing` | Faisal |
| 62  | GET    | `/api/v1/transfer-requests/by-car/{carId}` | Faisal |
| 63  | GET    | `/api/v1/transfer-requests/by-status/{status}` | Faisal |
| 64  | POST   | `/api/v1/transfer-requests/direct/{carId}`<br>`/{toEmail}/{toPhone}` | Faisal |
| 65  | GET    | `/api/v1/marketing/get` | Faisal |
| 66  | POST   | `/api/v1/marketing/add` | Faisal |
| 67  | PUT    | `/api/v1/marketing/update/{id}` | Faisal |
| 68  | DELETE | `/api/v1/marketing/delete/{id}` | Faisal |
| 69  | GET    | `/api/v1/email/test` | Faisal |
